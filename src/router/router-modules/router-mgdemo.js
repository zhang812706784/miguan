                ...
                children: [
                    {
                        ...
                        title: '虚拟机网络',
                        name: 'home_index',
                        component: () => import('@/views/scene-mgdemo/network/vsysnet.vue')
                    },
                ]}
        ]
    },
                ...
                children: [
                    {
                        ...
                        title: '日志',
                        name: 'asset_group',
                        component: () => import('@/views/scene-mgdemo/sysLog/log.vue')
                    }
                ]}
        ]
    },
                ...
                children: [
                    {
                        ...
                        title: '用户管理',
                        name: 'user_c',
                        component: () => import('@/views/scene-mgdemo/config/user.vue')
                    }
                ]}
        ]
    },
